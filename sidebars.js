module.exports = {
  docs: {
    ...
    "FAQ": ['faq', 'manual-backup', 'major-update', 'create-new-users', 'restore-files', 'restore-system', 'subdomain-cname', 'mount-hdd', 'smb-connect', 'rdp-connect', 'lynis', 'restore-backup'],
  },
};
