module.exports = {
  docs: {
    ...
    "Optional": [ {"Server Addons": ['firewall', 'vaultwarden', 'pi-hole', 'wireguard', 'pms', 'jellyfin', 'remotedesktop']}, 
          {"Nextcloud Addons": ['share-link-audit', 'onlyoffice', 'hpb', 'notify_push', 'imaginary', 'pdfannotate', 'whiteboard', 'appapi', 'pico', 'extract', 'more-apps']}, 
