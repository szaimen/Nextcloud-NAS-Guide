module.exports = {
  docs: {
    ...
    "Optional": ['optional', 'firewall', 'harden-ssh', 'onlyoffice', 'hpb', 'notify_push', 'whiteboard', 'pico', 'extract', 'bitwarden-rs', 'pi-hole', 'pivpn', 'pms', 'remotedesktop', 'digitize', 'mc'], 
    "FAQ": ['faq', 'improve-performance', 'manual-backup', 'major-update', 'create-new-users', 'restore-files', 'restore-system', 'change-update-time', 'subdomain-cname', 'mount-hdd', 'smb-connect', 'rdp-connect', 'lynis', 'restore-backup'],
  },
};
