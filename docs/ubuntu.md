...
1. **Download** the latest Ubuntu Server 26.04 LTS image by clicking [here](https://releases.ubuntu.com/resolute/ubuntu-26.04-live-server-amd64.iso) (this might take 30min because of slow download servers)
