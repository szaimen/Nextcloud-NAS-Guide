...
:::
1. **Download** the latest Ubuntu Desktop 24.04 LTS image by clicking [here](https://releases.ubuntu.com/noble/ubuntu-24.04.4-desktop-amd64.iso) (this might take 30min because of slow download servers)
