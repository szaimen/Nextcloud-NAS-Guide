...
:::
1. **Download** the latest Ubuntu Desktop 20.04.2 LTS image by clicking [here](https://releases.ubuntu.com/focal/ubuntu-20.04.4-desktop-amd64.iso) (this might take 30min because of slow download servers)
