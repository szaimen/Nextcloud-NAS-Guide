...
:::
1. **Download** the latest Ubuntu Desktop 22.04 LTS image by clicking [here](https://releases.ubuntu.com/jammy/ubuntu-22.04-desktop-amd64.iso) (this might take 30min because of slow download servers)
