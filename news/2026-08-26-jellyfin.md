...
`Jellyfin` is a media server for your own server and now available as a new option in the Not-supported Menu. It is a full alternative to [PLEX Media Server](/docs/pms).
